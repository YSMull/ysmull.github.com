  ...
  TopEnv['make-vector'] = function (list) {
    var v = new Array(), i;
  ...
  function clickEval(code_str) {
    init()
    global_log = ''
    global_res = ''
    var txt = code_str, o, res = null, time0 = new Date();
    ...
    while ((o = TopParser.getObject()) != null) {
      ...
      // printLog('=> ' + Str(o));#lambda
      var ss = Str(o);
      printLog(ss == '#lambda' ? '' : ss);
      if (o != null) res = o;
    }
    var time1 = new Date();
    global_log = global_log + "\n\n[Finished in " + ((time1 - time0) / 1000) + " seconds]"
    setRes(res);
